        ...
        <div className="content">
          <div className="container">
            <div className="pizza-page">
              <img className="pizza-page__image" src={state.imageUrl} alt="pizza" />
              <div>
                <h2 className="pizza-page__title">{state.title}</h2>
                <div className="pizza-page__info">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis tempore architecto
                  hic possimus eum eveniet, maiores quasi impedit aliquam distinctio. Lorem ipsum,
                  dolor sit amet consectetur adipisicing elit. Ipsum iusto mollitia vel ducimus
                  dolores nam consequuntur quos cum adipisci, quas, corrupti ipsam fuga tenetur
                  veritatis est natus fugit eum nobis nulla non magni incidunt deleniti odio
                  provident. Nostrum placeat praesentium, sapiente dicta aspernatur enim. Corrupti
                  laudantium maiores fugiat asperiores neque.
                </div>
